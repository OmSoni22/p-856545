...
const UnlockFullPotentialSection: React.FC = () => {
  return (
    <section className="bg-white flex w-full flex-col justify-center px-[70px] py-[126px] max-md:max-w-full max-md:px-5 max-md:py-[100px]">
        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          <div className="w-6/12 max-md:w-full max-md:ml-0">
            <div className="flex grow items-start gap-1 flex-wrap max-md:max-w-full max-md:mt-10">
              <img
                ...
                alt="AI Icon"
                className="aspect-[0.97] object-contain w-[72px] shrink-0 mt-[522px] max-md:mt-10"
              />
              <img
                ...
                className="aspect-[0.85] object-contain w-fit grow shrink-0 basis-0 rounded-[13px] max-md:max-w-full"
              />
            </div>
          </div>
          <div className="w-6/12 ml-5 max-md:w-full max-md:ml-0">
            <div className="flex flex-col self-stretch items-stretch text-[17px] font-semibold leading-[1.2] my-auto max-md:max-w-full max-md:mt-10">
              ...
              <Button
                variant="yellow"
                className="mt-[62px] pt-[15px] pb-[29px] px-[45px] rounded-[56px] max-md:mt-10 max-md:px-5"
              >
                Join Now
              </Button>
            </div>
