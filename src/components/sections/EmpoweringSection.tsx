  ...
  return (
    <section className="bg-white flex w-full flex-col items-center justify-center px-20 py-[147px] max-md:max-w-full max-md:px-5 max-md:py-[100px]">
      <div className="flex mb-[-29px] w-full max-w-[1165px] flex-col items-stretch max-md:max-w-full max-md:mb-2.5">
        <div className="flex items-center gap-5 flex-wrap justify-between max-md:max-w-full">
          <img
            ...
            className="aspect-[0.9] object-contain w-[234px] self-stretch shrink-0 max-w-full rounded-[10px]"
          />
          <img
            ...
            alt="AI Icon"
            className="aspect-[0.95] object-contain w-[72px] self-stretch shrink-0 my-auto"
          />
          <div className="self-stretch flex flex-col items-stretch my-auto max-md:max-w-full">
            <h2 className="text-[rgba(43,41,43,1)] text-[46px] font-semibold leading-[57px] max-md:max-w-full max-md:text-[40px] max-md:leading-[56px]">
              Empowering Businesses with AI-Powered Python
            </h2>
            <p className="text-[rgba(115,113,117,1)] text-lg font-medium leading-[30px] mt-[30px] max-md:max-w-full">
          ...
          <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
            <div className="w-[34%] max-md:w-full max-md:ml-0">
              <div className="flex flex-col whitespace-nowrap leading-[1.2] max-md:mt-10">
                <div className="text-[rgba(57,54,56,1)] text-2xl font-semibold self-stretch">
                  Streamline
                </div>
                <div className="text-[rgba(120,118,122,1)] text-[17px] font-normal mt-7">
                  Automate
                </div>
                <div className="text-[rgba(128,126,129,1)] text-[19px] font-medium mt-[26px]">
                  Innovate
                </div>
              </div>
            </div>
            <div className="w-[66%] ml-5 max-md:w-full max-md:ml-0">
              <div className="flex grow flex-col items-stretch font-medium max-md:mt-10">
                <div className="text-[rgba(37,37,41,1)] text-[23px] leading-[1.2]">
                  Optimize
                </div>
                <div className="text-[rgba(118,116,120,1)] text-[19px] leading-[41px] mt-[23px]">
