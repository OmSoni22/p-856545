        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          <div className="w-6/12 max-md:w-full max-md:ml-0">
            <div className="flex flex-col self-stretch items-stretch font-semibold my-auto max-md:max-w-full max-md:mt-10">
              <h1 className="text-[rgba(22,21,23,1)] text-[71px] leading-[86px] max-md:max-w-full max-md:text-[40px] max-md:leading-[54px]">
                Building a Successful AI-Powered Python Backend
              </h1>
              <p className="text-[rgba(156,163,171,1)] text-xl font-medium leading-[35px] mr-6 mt-[31px] max-md:max-w-full max-md:mr-2.5">
              ...
              <Button
                variant="primary"
                className="mt-[63px] pt-3.5 pb-[26px] px-9 max-md:mt-10 max-md:px-5"
              >
                Get Started
              </Button>
            </div>
          ...
          <div className="w-6/12 ml-5 max-md:w-full max-md:ml-0">
            <img
              ...
              className="aspect-[0.86] object-contain w-full grow max-md:max-w-full max-md:mt-[26px]"
            />
          </div>
        </div>
      </div>
